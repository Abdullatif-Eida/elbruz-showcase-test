...
import 'package:customer_management/presentation/save_customer/widgets/customer_progress_indicator.dart';
import 'package:customer_management/presentation/save_customer/widgets/first_step_form.dart';
import 'package:customer_management/presentation/save_customer/widgets/second_step_form.dart';
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Selector<SaveCustomerController, int>(
                        ...
                        builder: (context, value, _) {
                          return Text(
                            value == 0 ? 'Personal Information' : 'Extra Information',
                      ...
                      child: PageView(
                        ...
                        children: [
                          ...
                          SecondStepForm(
                            ...
                            initialPhoneNumber: initialValue?.formattedPhoneNumber,
                            onSavedBankAccount: controller.saveField('bankAccountNumber'),
                            onSavedEmail: controller.saveField('email'),
                            onSavedPhoneNumber: controller.saveField('phoneNumber'),
                      ...
                      child: Consumer<SaveCustomerController>(
                        builder: (context, controller, child) {
                          return ElevatedButton.icon(
                            ...
                            onPressed: controller.isButtonLoading ? null : () => controller.onTapSubmit(context),
